...
def mouse_callback(event, x, y, flags, param):
    global clicked_points, collecting_points
...
print("Presioná 'q' para detectar QR, 'h' para clic manual. ESC para salir.")
...
while True:
    ...
    if key == ord('q'):
        ...
        if retval and points is not None and len(points) == 1:
            ...
            print("Homografía a partir de QR calculada.")
        else:
        ...
        print("Seleccioná 4 puntos con clic. (Aborta con cualquier tecla)")
        ...
        print("Homografía a partir de puntos manuales calculada.")
        clicked_points = []
